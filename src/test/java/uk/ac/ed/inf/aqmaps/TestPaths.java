...
public class TestPaths {
  ...
  public static final TestPath COLLIDES_BUILDING =
      new TestPath(-3.186126, 55.943297, -3.186925, 55.943152, 0.000838331813174);
  ...
  public static final TestPath TRICKY_PATH_THROUGH_BUILDINGS =
      new TestPath(-3.186391, 55.944383, -3.18692, 55.944946, 0.001040032081404);

  /** A path which must evade 3 buildings, 4 segments */
  public static final TestPath COLLIDES_3_BUILDINGS =
      new TestPath(-3.186324, 55.942891, -3.187494, 55.945703, 0.003380889035005);
  ...
  public static final TestPath SHORTEST_ROUTE_LEAVES_CONFINEMENT =
      new TestPath(-3.189626, 55.942625, -3.188306, 55.942624, 0.001837367936062);
}
